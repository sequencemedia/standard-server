...
import Component from '#client/app/components/music/new-releases/component'

Enzyme.configure({ adapter: new Adapter() })

jest.mock('#client/app/components/common/order', () => {
  const MockOrder = () => (
...
jest.mock('#client/app/components/common/reset', () => {
  const MockReset = () => (
...
jest.mock('#client/app/components/common/latest', () => {
  const MockLatest = () => (
...
jest.mock('#client/app/components/common/albums', () => {
  const MockAlbums = () => (
