...
const log = debug('@sequencemedia:client:app:actions:music:top-albums')

log('`topAlbums` is awake')

const CHANGE = 'TOP_ALBUMS_CHANGE'
const CHANGE_ORDER = 'TOP_ALBUMS_CHANGE_ORDER'
const LATEST = 'TOP_ALBUMS_LATEST'
const LATEST_ORDER = 'TOP_ALBUMS_LATEST_ORDER'
