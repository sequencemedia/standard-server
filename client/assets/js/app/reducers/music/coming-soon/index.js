...
export function updateFulfilled ({ feedType = COMING_SOON } = {}, { response = {} } = {}) {
  log('updateFulfilled')

  return { feedType, ...response, status: RESOLVED }
}

export function updateOrderFulfilled ({ feedType = COMING_SOON } = {}, { response = {} } = {}) {
...
export function updateRejected ({ feedType = COMING_SOON } = {}, { error = {} } = {}) {
  log('updateRejected')

  return { feedType, exception: { ...error }, status: REJECTED }
}

export function updateOrderRejected ({ feedType = COMING_SOON, order } = {}, { error = {} } = {}) {
